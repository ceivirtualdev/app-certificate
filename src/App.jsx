        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 montserrat">
              Generador de
              <span className="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent"> Certificados</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Sistema profesional para la generación, validación y gestión de certificados académicos digitales
            </p>
