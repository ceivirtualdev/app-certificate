...
export const generateCertificatePDF = async (certificateData, appConfig) => {
  ...
  pdf.text('CERTIFICADO DE FINALIZACIÓN', pageWidth / 2, 45, { align: 'center' });

  pdf.setFontSize(16);
  pdf.setTextColor(100, 100, 100);
  pdf.text('Se certifica que', pageWidth / 2, 60, { align: 'center' });
  ...
  pdf.text(`Otorgado el ${fecha}`, pageWidth / 2, 135, { align: 'center' });
